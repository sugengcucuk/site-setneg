    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered" id="form_wizard_permohonan_baru" name="form_wizard_permohonan_baru">
            ...
            <div class="portlet-body form">
                <form class="form-horizontal" id="submit_form_permohonan_baru" name="submit_form_permohonan_baru" autocomplete="on">
                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <select class="form-control" name="list_pemohon" id="list_pemohon">
                                                    <option value=""></option>
                                                    <?php
                                                    if(isset($list_pemohon) && !empty($list_pemohon)){
                                ...
                                <div class="tab-pane" id="tab3">
                                    <div class="note note-danger">
                                        ...
                                        <p>Silahkan Lengkapi Data isian Waktu Penugasan, Dokumen serta Pembiayaan setiap Peserta.</p>
                                    </div>
                                    <hr/>
                                    <div class="row" >
                                    ...
                                    <div class="panel_peserta" id="panel_peserta">
                                        ...
                                        <input type="hidden" id="id_log_peserta" name="id_log_peserta" class="form-control" />
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-4 col-md-8">
                                    ...
                                    <button class="btn green button-submit" type="button" style="display: none;" disabled="true"> Kirim Permohonan <i class="fa fa-check"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
